...
class _LayoutParsingPipelineV3(BasePipeline):
...
class LayoutParsingPipelineV3(AutoParallelImageSimpleInferencePipeline):
    entities = ["layout_parsing_clclab"]

    @property
    def _pipeline_cls(self):
        return _LayoutParsingPipelineV3
